...
class SynthesisNetwork(torch.nn.Module):
        ...
        **layer_kwargs,                 # Arguments for SynthesisLayer.
        ...
        for idx in range(self.num_layers + 1):
            ...
            layer = SynthesisLayer(
                ...
                in_half_width=half_widths[prev], out_half_width=half_widths[idx], idx=idx,
                **layer_kwargs)
    ...
    def forward_test(self, ws, direction, index, is_ortho, **layer_kwargs):
        ...
        #if is_ortho:
        ws[index * 4] \
            = ws[index * 4] + direction
        # else:
        #     ws[index] \
        #         = ws[index] + direction

        for name, w in zip(self.layer_names, ws):
            x = getattr(self, name)(x, w, **layer_kwargs)
        if self.output_scale != 1:
            x = x * self.output_scale
    ...
    def forward_ppl(self, ws, **layer_kwargs):
