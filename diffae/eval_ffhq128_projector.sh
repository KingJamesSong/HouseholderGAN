...
#SBATCH -t 23:59:00
#SBATCH --gres gpu:2
#SBATCH -o o_file/eval/1022_ffhq128_projector.o
#SBATCH -e e_file/eval/1022_ffhq128_projector.e
...
python run_ffhq128.py  > out_file/eval/1022_ffhq128_projector.out 