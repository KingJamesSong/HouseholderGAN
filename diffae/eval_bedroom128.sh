...
#SBATCH -t 23:59:00
#SBATCH --gres gpu:1
#SBATCH -o o_file/eval/0202_bedroom128_multi_mlp_HP.o
#SBATCH -e e_file/eval/0202_bedroom128_multi_mlp_HP.e
...
python run_bedroom128.py  > out_file/eval/0202_bedroom128_multi_mlp_HP.out 
