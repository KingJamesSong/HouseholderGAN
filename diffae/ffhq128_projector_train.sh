...
#SBATCH -t 23:59:00
#SBATCH --gres gpu:2
#SBATCH -o o_file/train/1020_ffhq128_projector.o
#SBATCH -e e_file/train/1020_ffhq128_projector.e
...
python run_ffhq128.py  > out_file/train/1020_ffhq128_projector.out 