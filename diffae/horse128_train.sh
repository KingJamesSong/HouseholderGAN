...
#SBATCH -t 23:59:00
#SBATCH --gres gpu:2
#SBATCH -o o_file/train/0125_horse128_multi_mlp_HP.o
#SBATCH -e e_file/train/0125_horse128_multi_mlp_HP.e
...
python run_horse128.py  > out_file/train/0125_horse128_multi_mlp_HP.out 
