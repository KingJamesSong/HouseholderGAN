...
#SBATCH -t 23:59:00
#SBATCH --gres gpu:1
#SBATCH -o o_file/train/1220_ffhq128_multi_ortho.o
#SBATCH -e e_file/train/1220_ffhq128_multi_ortho.e
...
python run_ffhq128.py  > out_file/train/1220_ffhq128_multi_ortho.out 
