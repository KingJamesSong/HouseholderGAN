...
from hessian_penalty import hessian_penalty, ortho_jacob
...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device):
    ...
    for idx in pbar:
        ...
        ##Hessian Penalty or Orthogonal Jacobian
        loss_dis = hessian_penalty(generator, noise, fake_img)

        loss_dict["g"] = g_loss + 0.1 * loss_dis
