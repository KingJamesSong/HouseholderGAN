...
#                         "ada_aug_p": ada_aug_p,
#                     },
#                     f"checkpoint_FFHQv2/{str(i).zfill(6)}.pt",
#                 )
#
#
...
if __name__ == "__main__":
    ...
    if not os.path.exists(checkpoints_dir) and get_rank() == 0:
        os.mkdir(checkpoints_dir)

    args.checkpoints_dir = checkpoints_dir
    args.sample_dir = sample_dir

    if not os.path.exists(sample_dir) and get_rank() == 0:
        os.mkdir(sample_dir)
