...
def init_dataset_kwargs(data, square=False):
    ...
    try:
        dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, use_labels=True, max_size=None, xflip=False, square=square, resolution=512)
