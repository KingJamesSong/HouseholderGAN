...
python closed_form_factorization.py --out ./factor_256.pt \
        --resume_pkl ./training-runs_256/00003-stylegan3-r-ffhq-256x256-gpus3-batch6-gamma1/network-snapshot-000040.pkl --is_ortho &
