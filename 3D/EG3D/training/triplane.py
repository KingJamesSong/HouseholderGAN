...
class TriPlaneGenerator(torch.nn.Module):
    ...
    def synthesis_direction(self, ws, c, direction, index, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
