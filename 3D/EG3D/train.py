...
@click.option('--geometry_con',    help='geometry consistency loss.', metavar='FLOAT', type=click.FloatRange(min=0), default=10, required=False, show_default=True)
...
def main(**kwargs):
    ...
    rendering_options = {
        ...
        'geometry_con': opts.geometry_con,
